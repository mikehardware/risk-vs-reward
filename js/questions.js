export const questionSets = {
    ...
    "Set 3": {
      ...
      {
        "question": "Where are the anterior cruciate ligaments located?",
        "category": "Anatomy",
        "answers": {
          "A": "Shoulders",
          "B": "Elbows",
      ...
      {
        "question": "Which statement is not true of naked mole rats?",
        "category": "Animals",
        "answers": {
          "A": "They are insensitive to pain",
          "B": "They are the longest living rodents",
          "C": "They are resistant to cancer",
          "D": "They are native to Asia"
        },
        "correct": "D"
      },
      {
        "question": "Where can you find the largest cast iron statue in the world?",
        "category": "Cities",
        "answers": {
          "A": "Volgograd, Russia",
      ...
      {
        "question": "Which pasta name comes from the Italian for 'little tongues'?",
        "category": "Food",
        "answers": {
          "A": "Ziti",
          "B": "Cannelloni",
      ...
      {
        "question": "When playing the board game Monopoly, starting from 'Go' which of these properties would you pass first?",
        "category": "Games",
        "answers": {
          "A": "B&O Railroad",
          "B": "Virginia Avenue",
      ...
      {
        "question": "In the Star Wars movies, what color is Bantha milk?",
        "category": "Movies",
        "answers": {
          "A": "Blue",
          "B": "Pink",
      ...
      {
        "question": "To make things appear larger, a scientist typically uses a what?",
        "category": "Science",
        "answers": {
          "A": "Beaker",
          "B": "Bunsen burner",
      ...
      {
        "question": "Analogous to NCAA basketball's 'Final Four', the 'Frozen Four' is a series of playoff games in what college sport?",
        "category": "Sports",
        "answers": {
          "A": "Football",
          "B": "Lacrosse",
      ...
      {
        "question": "Which toy was originally manufactured as a wallpaper cleaner?",
        "category": "Toys",
        "answers": {
          "A": "Silly Putty",
          "B": "Play-Doh",
      ...
      {
        "question": "Who was the second US President to be impeached?",
        "category": "US History",
        "answers": {
          "A": "Andrew Johnson",
          "B": "Millard Fillmore",
      ...
      {
        "question": "Icequakes are earthquake-like phenomena that often occur on what continent?",
        "category": "World Geography",
        "answers": {
          "A": "Africa",
          "B": "Europe",
      ...
      questions: [
      {
        ...
        "category": "Anatomy",
        "answers": {
          "A": "Not attached to other bones",
          "B": "Strongest bone in the body",
          "C": "Smallest bone in the body",
          "D": "Spherical in shape"
        },
        "correct": "A"
      },
      {
        "question": "Now extinct, the dodo once lived on what island?",
        "category": "Animals",
        "answers": {
          "A": "Seychelles",
          "B": "Maldives",
      ...
      {
        "question": "In a restaurant, what member of the kitchen staff is usually responsible for making breads and desserts?",
        "category": "Food",
        "answers": {
          "A": "Sauté chef",
          "B": "Fry cook",
      ...
      {
        "question": "Which of these was not invented by Benjamin Franklin?",
        "category": "Inventions",
        "answers": {
          "A": "Barometer",
          "B": "Bifocal Glasses",
      ...
      {
        "question": "Which of these classic short stories prominently features a pumpkin?",
        "category": "Literature",
        "answers": {
          "A": "The Legend of Sleepy Hollow",
          "B": "The Tell-Tale Heart",
          "C": "The Gift of the Magi",
          "D": "The Devil and Daniel Webster"
        },
        "correct": "A"
      },
      {
      ...
      {
        "question": "Five St. Bernards, one mechanical dog head, and an actor in a dog costume were all reportedly used in the making of what movie?",
        "category": "Movies",
        "answers": {
          "A": "King Kong",
          "B": "Cujo",
      ...
      {
        "question": "Which one of these common plants is considered non-toxic?",
        "category": "Plants",
        "answers": {
          "A": "Daffodil",
          "B": "Azalea",
      ...
      {
        "question": "The mineral Iron Pyrite is commonly known as what?",
        "category": "Science",
        "answers": {
          "A": "Ruby",
          "B": "Topaz",
      ...
      {
        "question": "'Rabbit ears' are a device once commonly used to help improve which of the following?",
        "category": "Technology",
        "answers": {
          "A": "Cell phone battery life",
          "B": "DVD clarity",
          "C": "Internet speed",
      ...
      {
        "question": "Wild West gunslinger 'Doc' Holliday earned his nickname as what kind of doctor?",
        "category": "US History",
        "answers": {
          "A": "Optometrist",
          "B": "Dentist",
      ...
      {
        "question": "Which of these is the capital city of Canada?",
        "category": "World Geography",
        "answers": {
          "A": "Toronto",
          "B": "Montreal",
      ...
      {
        "question": "If it could talk, the animal that serves as the traditional symbol of the Democratic party would most likely say what?",
        "category": "Animals",
        "answers": {
          "A": "Oink!",
          "B": "Baa!",
      ...
      {
        "question": "Which crop was known in Europe before the year 1492?",
        "category": "Food",
        "answers": {
          "A": "Potato",
          "B": "Avocado",
      ...
      {
        "question": "Five hundred miles is how many furlongs?",
        "category": "Measurements",
        "answers": {
          "A": "5000",
          "B": "4000",
      ...
      {
        "question": "'Bow wow wow yippie yo yippie yay' is a lyric from a classic funk song with what fitting title?",
        "category": "Music",
        "answers": {
          "A": "Atomic Pig",
          "B": "Atomic Cow",
      ...
      {
        "question": "What is the most visited US National Park?",
        "category": "Parks",
        "answers": {
      ...
      {
        "question": "Heliotropic plants do what?",
        "category": "Plants",
        "answers": {
          "A": "Bloom several times per year",
          "B": "Release spores to reproduce",
          "C": "React to movement of the sun",
          "D": "Grow only near the equator"
        },
        "correct": "C"
      },
      {
        "question": "Which of these is not one of the Plagues of Egypt mentioned in the Book of Exodus?",
        "category": "Religion",
        "answers": {
          "A": "Lice",
          "B": "Frogs",
      ...
      {
        "question": "Light in which of these colors of the rainbow has the shortest wavelength?",
        "category": "Science",
        "answers": {
          "A": "Green",
          "B": "Yellow",
      ...
      {
        "question": "Which of these M*A*S*H television show characters was from Missouri?",
        "category": "Television",
        "answers": {
          "A": "Col. Blake",
          "B": "Major Burns",
      ...
      {
        "question": "Which one of these people famous in Texas history did not die at the Battle of the Alamo?",
        "category": "US History",
        "answers": {
          "A": "William B. Travis",
          "B": "Jim Bowie",
      ...
      {
        "question": "Man-made levees are raised embankments designed to hold back what?",
        "category": "Vocabulary",
        "answers": {
          "A": "Pollution",
          "B": "Floodwaters",
      ...
      {
        "question": "The equator lies halfway between the North and South what?",
        "category": "World Geography",
        "answers": {
          "A": "Poles",
          "B": "Koreas",
